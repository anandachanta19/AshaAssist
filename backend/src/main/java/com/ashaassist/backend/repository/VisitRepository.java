 ...
 * Provides standard CRUD operations and a custom method to find the most recent visits for a user.
 */
public interface VisitRepository extends JpaRepository<Visit, Long> {
    /**
     * Finds the top 5 most recent visits for a given Asha Karmi, ordered by creation date descending.
     *
